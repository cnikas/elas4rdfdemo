...
import static gr.forth.ics.isl.elas4rdfdemo.QuestionAnalysis.stopLists;
...
public class StringUtils {
     ...
     * @return
     */
    public static ArrayList<String> removePunctuantions(ArrayList<String> words) {
        ArrayList<String> cleanWords = new ArrayList<>();
        String tmpWord;

        for (String word : words) {
            //Replace all punctuations with the blank String
     ...
     * removes punctuations as well as it applies stemming
     *
     * @param words
     * @return
     */
    public static ArrayList<String> cleanString(ArrayList<String> words) {
        words = removePunctuantions(words);
